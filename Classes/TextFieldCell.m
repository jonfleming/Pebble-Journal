...
- (void)layoutSubviews {
	...
	self.textLabel.frame = CGRectMake(LABEL_X , CONTENT_Y, LABEL_WIDTH, CONTENT_HEIGHT);
	self.textField.frame = CGRectMake(LABEL_X , CONTENT_Y, LABEL_WIDTH, CONTENT_HEIGHT);
